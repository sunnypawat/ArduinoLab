  ...
  while (client.connected())
  {
    if (client.available())
    {
      ...
      { 
        ...
        temperature = temp;
        humidity = humid;
        M5STACK_DATA = "Current temperature is ";
        M5STACK_DATA += temperature;
        M5STACK_DATA += " C ";
        M5STACK_DATA += "Humidity ";
        M5STACK_DATA += humidity;
      }
      ...
      if (readyResponse) // отдать браузеру
      {
        ...
        else
        {
          ...
          client.print("<span>Note: please press and hold any three buttons on the device for temperature and humidity</span>");
          client.print("<br>");
